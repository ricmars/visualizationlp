  ...
  return (
    <ModalPortal isOpen={isOpen}>
      <div
        ...
        onClick={onClose}
      >
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[90] w-full max-w-md">
          <div
            className="bg-[rgb(14,10,42)] text-white rounded-lg shadow-xl border border-gray-600"
            role="dialog"
            aria-labelledby="object-selector-title"
            aria-modal="true"
